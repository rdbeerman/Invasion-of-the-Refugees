...
GazDesignate.EnabledUnits = { "SA342M - Ford 2 - 2", --Corresponds with the field "Pilot Name" in the Mission Editor. Only SA342M whose Pilots are listed here can use the designator
                              "SA342M - Ford 2 - 1",
                              "SA342M - Ford 2 - 3",
                              "SA342M - Ford 2 - 4"
                            }
...
GazDesignate.UpdateInt = 0.2 --Seconds between each recalculation of the laser point, while laser is active, adjust to longer intervals if you run into performance issues 
